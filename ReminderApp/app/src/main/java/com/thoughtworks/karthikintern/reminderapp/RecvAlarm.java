...
/**
 * Created by karthikintern on 9/22/14.
 */
public class RecvAlarm  extends BroadcastReceiver{
    ...
    public void setAlarm(Context context) {
        ...
        Intent intent = new Intent(context, RecvAlarm.class);
        alarmIntent = PendingIntent.getBroadcast(context, 0, intent, 0);
         /*Calendar calendar = Calendar.getInstance();
        calendar.setTimeInMillis(System.currentTimeMillis());
        // Set the alarm's trigger time to 8:52 a.m.
       ...
       // alarmMgr.setInexactRepeating(AlarmManager.RTC_WAKEUP,
        ...
        //alarmMgr.setRepeating(AlarmManager.RTC_WAKEUP, System.currentTimeMillis(),System.currentTimeMillis()+ 1000 * 5 , alarmIntent);
