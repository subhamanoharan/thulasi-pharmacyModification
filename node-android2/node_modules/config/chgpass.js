...
var smtpTransport = nodemailer.createTransport("SMTP",{
    service:"Gmail",auth: {
        user: "subhamanoharanbe@gmail.com",
        pass: "********"
      }
});
...
user.findOne({ email: email }, function (err, doc){
  ...
  doc.save();
var mailOptions = {
    from: "Thulasi Pharmacy  <subhamanoharanbe@gmail.com>",
    to: email,
    subject: "Password reset request ",
    text: "Hello "+email+".  Code to reset your Password is "+temp+".\n\nRegards,\nThulasi Tech,\nThulasi Pharmacices India Pvt.Ltd.",
}
...
callback({'response':"Email Id not registered .",'res':false});
}
});
}
