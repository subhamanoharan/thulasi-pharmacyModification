    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String token = "ThulasiToken";
                SharedPreferences.Editor edit = pref.edit();
                //Storing Data using SharedPreferences
                edit.putString("token", token);
                //edit.putString("phno",phno);
                edit.commit();
                String jsonstr = "Logged in successfuly";
            ...
            public void onClick(View view) {
                ...
                cont.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        //if (json != null) {
                        //try {
                        String jsonstr1 = "Check Mail for verification code";
                        //if (json.getBoolean("res")) {
                        //Log.e("JSON", jsonstr);
                        Toast.makeText(getApplication(), jsonstr1, Toast.LENGTH_LONG).show();
                        ...
                        cont_code.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                // if (json != null) {
                                //try {
                                String jsonstr = "Password Reset - Check Email";
